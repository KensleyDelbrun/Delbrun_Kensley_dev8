...
export default function HomeScreen() {
  ...
  const loadFeaturedArticles = async () => {
    ...
    if (error) {
      ...
      // Shuffle the array locally and take the first 5
    ...
    <>
      ...
      >
        ...
        <Text style={styles.searchPlaceholder}>
          {t('Rechercher un sujet...', 'Chèche yon sijè...')}
        </Text>
      </TouchableOpacity>
      ...
      <View style={styles.section}>
        <Text style={styles.sectionTitle}>
          {t('Actualités du Moment', 'Aktyalite Jou a')}
        </Text>
      </View>
    </>
  );
  ...
  const ListFooter = () => (
    <>
      {categories.length > 0 && (
        <View style={styles.section}>
          <Text style={styles.sectionTitle}>
            {t('Explorer par Thème', 'Eksplore pa Tèm')}
          </Text>
          <View style={styles.themesGrid}>
            ...
            >
              <Text style={styles.themeTitle}>
                {t('Constitution Haïtienne', 'Konstitisyon Ayisyen')}
              </Text>
            </TouchableOpacity>
            <TouchableOpacity
            ...
            >
              <Text style={styles.themeTitle}>
                {t('Institutions de l\'État', 'Enstitisyon Leta')}
              </Text>
            </TouchableOpacity>
            <TouchableOpacity
            ...
            >
              <Text style={styles.themeTitle}>
                {t('Culture & Traditions', 'Kilti & Tradisyon')}
              </Text>
            </TouchableOpacity>
            <TouchableOpacity
