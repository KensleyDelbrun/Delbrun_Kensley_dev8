    ...
    <>
      <View style={styles.titleSection}>
        <Text style={styles.title}>
          {t('Toutes les Catégories', 'Tout Kategori yo')}
        </Text>
        <Text style={styles.subtitle}>
          {t('Explorez tous les domaines de connaissance', 'Eksplore tout domèn konesans yo')}
        </Text>
      </View>
      ...
      <View style={styles.searchContainer}>
        ...
        <TextInput
          ...
          placeholder={t('Rechercher une catégorie...', 'Chèche yon kategori...')}
  ...
  const EmptyState = () => (
    <View style={styles.emptyState}>
      <Text style={styles.emptyText}>
        {t('Aucune catégorie trouvée', 'Pa gen kategori jwenn')}
      </Text>
    </View>
  );
