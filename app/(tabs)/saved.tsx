...
import { getOfflineArticles, OfflineArticle } from '@/lib/offlineStorage';
      ...
      <SafeAreaView style={styles.container} edges={['top']}>
        ...
        <View style={styles.emptyState}>
          <Text style={styles.emptyTitle}>
            {t('Connexion requise', 'Koneksyon obligatwa')}
          </Text>
          <Text style={styles.emptyText}>
            {t('Connectez-vous pour sauvegarder des articles', 'Konekte pou sovgade atik yo')}
          </Text>
        </View>
      </SafeAreaView>
    );
    ...
    <>
      <View style={styles.titleSection}>
        <Text style={styles.title}>
          {t('Articles Sauvegardés', 'Atik Sovgade yo')}
        </Text>
      </View>
      {savedArticles.length > 0 && (
        <View style={styles.searchContainer}>
          ...
          <TextInput
            ...
            placeholder={t('Rechercher dans les sauvegardés...', 'Chèche nan sovgade yo...')}
  ...
  const ListEmpty = () => (
    <View style={styles.emptyState}>
      {savedArticles.length === 0 ? (
        <>
          <Text style={styles.emptyTitle}>
            {t('Aucun article sauvegardé', 'Pa gen atik sovgade')}
          </Text>
          <Text style={styles.emptyText}>
            {t('Sauvegardez des articles pour les lire hors ligne', 'Sovgade atik pou li yo san koneksyon')}
          </Text>
        </>
      ) : (
        <Text style={styles.emptyText}>
          {t('Aucun article trouvé', 'Pa gen atik jwenn')}
        </Text>
      )}
    </View>
  );
